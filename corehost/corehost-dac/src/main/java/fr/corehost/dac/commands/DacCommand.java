...
public class DacCommand implements CommandExecutor {
    ...
    public DacCommand(CoreHostDac plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (action) {
            case "create":
                ...
                createLocalDac(player, maxPlayers);
                break;
            case "join":
                if (args.length < 2) {
                ...
                DacGameInstance instance = plugin.getGameManager().getInstance(hostId);
                if (instance != null) {
    ...
    private void createLocalDac(Player player, int maxPlayers) {
        ...
        if (coreGame != null && coreGame.getRedisManager() != null) {
            ...
            request.addProperty("gameType", "dac");
